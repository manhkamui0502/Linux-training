...
int main() {
  ...
  struct human_identify person_a = {"Tran Duc Manh", 
                                    ...
                                    "0123456789", 
                                    "Vinh Phuc"};
  person_a.phone_number[sizeof(person_a.phone_number) - 1] = '\0';
  person_a.full_name[sizeof(person_a.full_name) - 1] = '\0';
  person_a.home_town[sizeof(person_a.home_town) - 1] = '\0';
